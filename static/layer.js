...
function() {
    return function(t) {
        ...
        i = e(30),
        o = e(1).Symbol,
        c = "function" == typeof o; (t.exports = function(t) {
    ...
    function(t, n, e) {
        ...
        s = function(t, n, e) {
            ...
            _ = v ? r: h ? r[n] : (r[n] || {})[u];
            v && (e = n);
            for (a in e)(f = !p && _ && void 0 !== _[a]) && a in x || (l = f ? _[a] : e[a], x[a] = v && "function" != typeof _[a] ? e[a] : y && f ? o(l, r) : m && _[a] == l ?
            function(t) {
    ...
    function(t, n, e) {
        ...
        t.exports = function(t, n, e, m, x, b, _) {
            ...
            P = !1,
            C = t.prototype,
            T = C[p] || C["@@iterator"] || x && C[x],
            E = T || k(x),
            M = x ? O ? k("entries") : E: void 0,
            A = "Array" == n ? C.entries || T: T;
            ...
            _) for (w in g) w in C || o(C, w, g[w]);
            else i(i.P + i.F * (v || P), n, g);
            return g
        }
    },
    function(t, n) {
    ...
    function(t, n, e) {
        ...
        f.addEventListener("message", b, !1)) : r = m in a("script") ?
        function(t) {
    ...
    function(t, n, e) {
        ...
        function(t, n) {
            var e;
            return null !== t ? (u[s] = r(t), e = new u, u[s] = null, e[c] = t) : e = a(),
            void 0 === n ? e: i(e, n)
        }
    },
    function(t, n, e) {
    ...
    function(t, n, e) {
        ...
        A = function(t) {
            ...
            r = 0; e.length > r;) if (n = e[r++], n.fail || !A(n.promise)) return ! 1;
            return ! 0
        },
        F = function(t) {
            y.call(u,
            function() {
                var n;
                w ? _.emit("rejectionHandled", t) : (n = u.onrejectionhandled) && n({
                    promise: t,
                    reason: t._v
                })
            })
        ...
        L = function(t) {
            ...
            if (!e._d) {
                ...
                e = e._w || e;
                try {
                    if (e === t) throw b("Promise can't be resolved itself"); (n = O(t)) ? m(function() {
                        var r = {
                            _w: e,
                            _d: !1
                        };
    ...
    function(t, n, e) {
        ...
        u = {
            ...
            open: function(t) {
                this.close();
                var n = r(this.vue, t);
                return this.instanceList.push(n),
            ...
            close: function(closeFlag) {
                ...
                if (this.instanceList.length > 0) {
                    this.instanceList.pop().visible = !1,
                    this.close()
                }
                return ! 1
            },
            ...
            dialog: function(t) {
                ...
                e = {
                    ...
                    bindFun:t.bindFun?t.bindFun:function(){},
                    closeFlag:t.closeFlag ? t.closeFlag : false
                };
